class Translation(object):
    START_TEXT = """Hi!
please read the TnC before proceeding: https://t.me/kunjappansupportez/43
...
by opening https://github.com/hopepsycho/adimakann and clicking on the Pink Button
