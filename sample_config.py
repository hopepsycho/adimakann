...
class Config:
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/kunjappansupportez")
    ...
    # please reopen
    # https://github.com/hopepsycho/adimakann/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/kunjappansupportez"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @hopepsycho")
